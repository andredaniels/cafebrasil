...
class WonderPlugin_Slider_Model {
	...
	function generate_body_code($id, $has_wrapper) {
		...
		if ($item_row != null)
		{
			...
			$boolOptions = array('autoplay', 'randomplay', 'autoplayvideo', 'isresponsive', 'showtext', 'showtimer', 'showbottomshadow', 'navshowpreview', 'lightboxresponsive', 'lightboxshownavigation', 'lightboxshowtitle', 'lightboxshowdescription');
