<?php
    ...
    define('S_DATE_FORMAT_HIS_WB', 'm-d-Y H:i:s');	// Month at First!!!
    ...
    define('S_VERSION', '0.5.3');
    define('S_USER', 'user');
	
	define('S_CATEGORIES', 'products_categories');
	define('S_BRANDS', 'products_brands');
	 ...
	 * Plugin name
	 */
	define('S_WP_PLUGIN_NAME', 'Ready! Ecommerce');
	/**
	 * End of Line
	 */
	define('S_EOL', "\n");